...
void login_config_default()
{
    ...
    login_config.servername = "Ivalice";
...
{
    ShowInfo(CL_WHITE "Ivalice version %d.%02d.%02d" CL_RESET "\n", XI_MAJOR_VERSION, XI_MINOR_VERSION, XI_REVISION);
    ShowInfo(CL_GREEN "Website:" CL_RESET "\thttps://github.com/Hokuten85/Ivalice\n");
    if (flag)
    {
        exit(EXIT_FAILURE);
    }
