...
local function CharCreate(player)
    ...
    if START_INVENTORY > 30 then
        player:changeContainerSize(xi.inv.INVENTORY, START_INVENTORY)
        player:changeContainerSize(xi.inv.MOGSATCHEL, START_INVENTORY)
		player:changeContainerSize(xi.inv.MOGLOCKER, START_INVENTORY)
