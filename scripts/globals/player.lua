...
local function CharCreate(player)
    ...
    if START_INVENTORY > 30 then
        player:changeContainerSize(xi.settings.INVENTORY, xi.settings.START_INVENTORY)
        player:changeContainerSize(xi.settings.MOGSATCHEL, xi.settings.START_INVENTORY)
		player:changeContainerSize(xi.settings.MOGLOCKER, xi.settings.START_INVENTORY)
