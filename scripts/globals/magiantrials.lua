...
function xi.magian.checkMagianTrial(player, conditions)
    local trials = xi.magian.trials
                ...
                if increment > 0 then
                    ...
                    if cacheData.progress < trialSQL.objectiveTotal then
                        ...
                        if remainingObjectives == 0 then
                            player:messageBasic(xi.msg.basic.MAGIAN_TRIAL_COMPLETE, trialOnItem) -- trial complete
                        else
                            player:messageBasic(xi.msg.basic.MAGIAN_TRIAL_COMPLETE - 1, trialOnItem, remainingObjectives) -- trial <trialid>: x objectives remain
                        end
